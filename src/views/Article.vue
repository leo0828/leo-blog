    ...
    >
      ...
      >
        <router-link
          class="link back-btn"
          to="/"
        ><i class="el-icon-back el-icon--left"></i>Back</router-link>
        ...
        <div class="l-pagination">
          <el-button
            ...
            v-show="prevPost"
            plain
          ><i class="el-icon-arrow-left el-icon--left"></i>Prev</el-button>
          <el-button
            class="nav-btn next-btn"
            @click="next"
            v-show="nextPost"
            plain
          >Next<i class="el-icon-arrow-right el-icon--right"></i></el-button>
        </div>
      </div>
    </transition>
  </section>
